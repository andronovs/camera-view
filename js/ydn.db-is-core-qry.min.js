...
function ja(a,b){var c=Array.prototype.slice.call(arguments,1);return function(){var b=c.slice();b.push.apply(b,arguments);return a.apply(this,b)}}var ka=Date.now||function(){return+new Date};function la(a,b){var c=a.split("."),d=q;c[0]in d||!d.execScript||d.execScript("var "+c[0]);for(var e;c.length&&(e=c.shift());)!c.length&&r(b)?d[e]=b:d[e]?d=d[e]:d=d[e]={}}
...
function Ra(){var a=q.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!D("Presto")&&(a=function(){var a=document.createElement("IFRAME");a.style.display="none";a.src="";document.documentElement.appendChild(a);var b=a.contentWindow,a=b.document;a.open();a.write("");a.close();var c="callImmediate"+Math.random(),d="file:"==b.location.protocol?"*":b.location.protocol+"//"+b.location.host,a=ia(function(a){if(("*"==d||a.origin==d)&&a.data==
...
l.toString=function(){return this.valueOf().replace("^|","|").replace("^:",":")};l.tb=function(){return this.b};l.jb=function(){return this.a};function uc(a){return t(a.a)?a.a.join("^|"):a.a instanceof Date?+a.a:a.a}l.sb=function(){return this.c};function vc(a){if(w(a)){for(var b=[],c=0,d=a.length;c<d;c++)b[c]=a[c];return b}return a};function P(a,b,c,d){a>b&&(b=a=void 0);null===a&&(a=void 0);null===b&&(b=void 0);this.lower=a;this.upper=b;this.lowerOpen=!!c;this.upperOpen=!!d}l=P.prototype;l.lower=void 0;l.upper=void 0;l.lowerOpen=!1;l.upperOpen=!1;l.toJSON=function(){var a;a=this||{};return{lower:a.lower,upper:a.upper,lowerOpen:a.lowerOpen,upperOpen:a.upperOpen}};function wc(a){return xc(a)}function yc(a){return new P(a,a,!1,!1)}function zc(a,b,c,d){return new P(a,b,c,d)}function Ac(a,b){return new P(void 0,a,void 0,!!b)}
function Bc(a,b){return new P(a,void 0,!!b,void 0)}function Cc(a){var b;if(t(a))b=Ga(a),b.push("\uffff");else if(x(a))b=a+"\uffff";else if(z(a))b=a+2.220460492503131E-16,a-=2.220460492503131E-16;else return yc(a);return zc(a,b,!1,!0)}function xc(a){return null!=a?null!=a.upper&&null!=a.lower?Dc.bound(a.lower,a.upper,!!a.lowerOpen,!!a.upperOpen):null!=a.upper?Dc.upperBound(a.upper,a.upperOpen):null!=a.lower?Dc.lowerBound(a.lower,a.lowerOpen):null:null}
...
function Fc(a,b,c,d,e){if(c)if(c.lowerOpen||c.upperOpen||null==c.lower||null==c.upper||0!==O(c.lower,c.upper)){if(null!=c.lower){var f=c.lowerOpen?" > ":" >= ";d.push(a+f+"?");e.push(Gc(c.lower,b))}null!=c.upper&&(f=c.upperOpen?" < ":" <= ",d.push(a+f+"?"),e.push(Gc(c.upper,b)))}else d.push(a+" = ?"),e.push(Gc(c.lower,b))}
...
Kc;this.f=x(e)?e:t(a)?this.keyPath.join(","):a;this.c=ta(this.f);this.b=this.h?null:this.keyPath.split(".");this.g=f||null}var Kc="TEXT";function Gc(a,b){if("DATE"==b){if(a instanceof Date)return+a}else return null!=b?a:Wb(a)}
...
this.keyPath.split("."):[];this.a=e||[];a=[];for(b=0;b<this.a.length;b++){c=this.a[b].getName();if(0<=a.indexOf(c))throw new F('index "'+c+'" already defined in store: '+this.f);a.push(c)}this.J=!!f;this.T=!!g;this.m=x(this.type)?this.type:Kc;this.g=t(this.keyPath)?this.keyPath.join(","):x(this.keyPath)?this.keyPath:"_ROWID_";this.c=ta(this.g);this.j=[]}l=Pc.prototype;l.J=!1;l.T=!1;
...
function Rc(a,b,c,d,e,f,g){a=Sc(a,b,c,d,e,f,g);b="";0!=c&&(b+="SELECT "+a.select);b+=" FROM "+a.from;a.o&&(b+=" WHERE "+a.o);a.group&&(b+=" GROUP BY "+a.group);a.H&&(b+=" ORDER BY "+a.H);return b}
function Sc(a,b,c,d,e,f,g){var h={select:"",from:"",o:"",group:"",H:""},k=a.g,n=a.c,p=null;d!==k&&x(d)&&(p=Tc(a,d));var m=!!p,u=d||k,v=ta(u),y=m?p.type:a.type,A=m&&p.multiEntry;h.from=Uc(a);6===c?h.select="COUNT("+n+")":3===c||1===c||2===c?(h.select=n,null!=d&&d!=k&&(h.select+=", "+v)):h.select="*";d=g?"DISTINCT ":"";k=[];A?(A=ta("ydn.db.me:"+a.getName()+":"+p.getName()),h.select=6===c?"COUNT("+d+A+"."+v+")":3===c||1===c||2===c?"DISTINCT "+Uc(a)+"."+n+", "+A+"."+v+" AS "+u:"DISTINCT "+Uc(a)+".*, "+
A+"."+v+" AS "+u,h.from=A+" INNER JOIN "+Uc(a)+" USING ("+n+")",null!=e&&(Fc(A+"."+v,y,e,k,b),0<k.length&&(h.o=h.o?h.o+(" AND "+k.join(" AND ")):k.join(" AND ")))):null!=e&&(Fc(v,y,e,k,b),0<k.length&&(h.o=h.o?h.o+(" AND "+k.join(" AND ")):k.join(" AND ")));m&&!p.unique&&g&&(h.group=v);a=f?"DESC":"ASC";h.H=v+" "+a;m&&(h.H+=", "+n+" "+a);return h}
function Vc(a,b,c,d,e,f,g,h,k){var n,p,m,u;null!=e?(n=e.lower,p=e.upper,m=e.lowerOpen,u=e.upperOpen,f?null!=p?(e=O(h,p),-1==e?(p=h,u=k):0==e&&(u=k||u)):(p=h,u=k):null!=n?(e=O(h,n),1==e?(n=h,m=k):0==e&&(m=k||m)):(n=h,m=k)):f?(p=h,u=k):(n=h,m=k);e=new P(n,p,!!m,!!u);d=d?Tc(a,d):null;b=Sc(a,c,b,d?d.f:a.g,e,f,g);b="SELECT "+b.select+" FROM "+b.from+(b.o?" WHERE "+b.o:"")+(b.group?" GROUP BY "+b.group:"")+" ORDER BY "+b.H;d&&(b+=", "+a.c+(f?"DESC":"ASC"));return b}
function Wc(a,b,c,d,e,f,g,h,k,n){var p=Tc(a,d),m=p.f;d=p.c;var u=a.c,v=k?" <":" >",v=g?v+" ":v+"= ";g=Gc(f,p.type);h=Gc(h,a.type);p="";e?(a=Sc(a,c,b,m,e,k,n),a.o+=" AND ",p=d+v+"?",c.push(g)):(e=k?Ac(f,!0):Bc(f,!0),a=Sc(a,c,b,m,e,k,n),p=a.o,a.o="");a.o+="("+p+" OR ("+d+" = ? AND "+u+v+"?))";c.push(g);c.push(h);return"SELECT "+a.select+" FROM "+a.from+" WHERE "+a.o+(a.group?" GROUP BY "+a.group:"")+" ORDER BY "+a.H}l.clone=function(){return Qc(this.toJSON())};
l.index=function(a){return this.a[a]||null};function Tc(a,b){return Da(a.a,function(a){return a.getName()==b})}function Xc(a,b){for(var c=0;c<a.a.length;c++)if(!Nc(a.a[c].keyPath,b))return a.a[c];return null}function Yc(a,b){return b===a.keyPath?!0:Ca(a.a,function(a){return a.getName()==b})}function Uc(a){return ta(a.f)}
...
function cd(a,b,c){var d=[],e=[];c=r(c)?c:ad(a,b);r(c)&&(e.push(a.c),d.push(Gc(c,a.type)));for(var f=0;f<a.a.length;f++){var g=a.a[f];if(!g.multiEntry&&g.getName()!==a.keyPath&&"_default_"!=g.getName()){var h;h=g;var k=b;if(null!=k)if(w(h.keyPath)){for(var n=[],p=0,m=h.keyPath.length;p<m;p++){var u=Tb(k,h.keyPath[p]);n[p]=u}h=n}else h=Tb(k,h.keyPath);else h=void 0;null!=h&&(d.push(Gc(h,g.type)),e.push(g.c))}}a.T?a.T&&!a.keyPath&&0==a.a.length&&(x(b)&&-1==b.indexOf(";base64,")?d.push(b):d.push(Q(b)),
e.push("_default_")):(d.push(Q(b)),e.push("_default_"));a=[];for(f=d.length-1;0<=f;f--)a[f]="?";return{Na:e,Ya:a,values:d,key:c}}
function dd(a,b){if(!b)return"missing store: "+a.f;if(a.f!=b.f)return"store name, expect: "+a.f+", but: "+b.f;var c=Nc(a.keyPath,b.keyPath);if(c)return"keyPath, "+c;if(r(a.b)&&r(b.b)&&a.b!=b.b)return"autoIncrement, expect:  "+a.b+", but: "+b.b;if(a.a.length!=b.a.length)return"indexes length, expect:  "+a.a.length+", but: "+b.a.length;if(r(a.type)&&r(b.type)&&(w(a.type)?!Ia(a.type,b.type):a.type!=b.type))return"data type, expect:  "+a.type+", but: "+b.type;for(c=0;c<a.a.length;c++){var d=Tc(b,a.a[c].getName()),
...
*/
function U(a,b,c){c=c||{};this.s=c.mechanisms||(lc||Cb()||D("iPad")||D("iPod")?Ha(vd,1):vd);this.m=c.size;this.v=r(c.connectionTimeout)?c.connectionTimeout:6E4;this.a=null;this.g=[];this.ja=!1;var d;if(b instanceof ld)d=b;else if(B(b)){c.autoSchema||!r(b.stores)?d=new pd(b):d=new ld(b);var e=b.stores?b.stores.length:0;for(c=0;c<e;c++)T(d,b.stores[c].name)}else d=new pd;this.c=d;for(c=0;c<this.c.count();c++);r(a)&&this.j(a);this.f=new E}U.prototype.logger=null;
U.prototype.A=function(a){if(r(a)){var b=function(b){a(b.toJSON());a=void 0};if(this.a)this.a.N(b);else{var c=this;this.transaction(function(a){c.a.N(b,a)},null,G)}}return this.c?this.c.toJSON():null};U.prototype.j=function(a){if(this.a)throw new Mb("Already connected with "+this.h);this.h=a;wd(this)};U.prototype.getName=function(){return this.h};var vd="indexeddb sqlite websql localstorage sessionstorage userdata memory".split(" ");l=U.prototype;l.va=function(){return null};
function wd(a){function b(b,e){b?(a.Pa=NaN,d.bb=function(){},d.Fa=function(){a.a=null},d.Ta=function(){},setTimeout(function(){xd(a,e);yd(a)},10),c.callback(e)):(setTimeout(function(){xd(a,new sc(a,e));if(a.g)for(var b;b=a.g.shift();)b.D&&b.D("error",e)},10),c.l(e))}for(var c=new E,d=null,e=a.s,f=0;f<e.length;f++){var g=e[f].toLowerCase();if(d=a.va(g)){d=a.va(g);break}}null===d?(e=new sd("No storage mechanism found."),b(!1,new sc(a,e))):wb(d.connect(a.h,a.c),function(a){this.a=d;b(!0,new qc("ready",
this,parseFloat(d.ab()),parseFloat(a),null))},function(a){b(!1,a)},a)}l.Ga=function(){if(this.a)return this.a.$a()};l.ma=function(a,b){this.f.U().Ia(a,b)};function xd(a,b){setTimeout(function(){a.c.b&&a.f.c||(b instanceof rc?a.f.l(b.error):a.f.callback())},4)}function zd(a){return!!a.a&&a.a.Ea()}l.close=function(){this.a&&(this.a.close(),this.a=null)};l.wb=function(){return this.a?this.a.Za():null};l.Pa=NaN;function yd(a){var b=a.g.shift();b&&a.transaction(b.ia,b.pb,b.mode,b.D);a.Pa=ka()}l.ja=!1;
...
0;c<g.g.length;c++)(0,g.g[c])(a,b);g.g.length=0;(c=g.c.shift())&&g.P(c.ia,c.F,c.mode,c.D);g.a=0})}};l.M=function(){var a=this.b;return"B"+a.f+"T"+a.b};l.request=function(a,b,c,d){function e(a,b){f.a=null;d&&d(a,b)}var f=new J(a);a=c||G;var g=this;Ud(this.b)&&Zd(this,b,a)?(b=this.b.a,this.a++,ec(f,b,this.M()+"R"+this.a),this.g.push(e)):g.P(function(){var a=g.b.a;g.a++;ec(f,a,g.M()+"R"+g.a)},b,a,e);return f};
l.Z=function(a,b,c,d,e){d=d||G;var f=this,g;if(Ud(f.b)&&Zd(this,c,d)){var h=f.b.a;f.a++;g=f.M()+"R"+f.a;b(h,g,function(b,c){f.i=h;c?a.l(b):a.callback(b);f.i=null});b=null}else f.P(function(){var c=f.b.a;f.a++;g=f.M()+"R"+f.a;b(c,g,function(b,d){f.i=c;d?a.l(b):a.callback(b);f.i=null});b=null},c,d,e)};l.getName=function(){return this.j.getName()};function ae(a,b){Yd.call(this,a,b)}C(ae,Yd);ae.prototype.logger=null;ae.prototype.request=function(a,b,c){var d,e,f,g=ae.C.request.call(this,a,b,c,function(a,b){g.a=null;if(d)"complete"!=a&&(f=!0,e=b),d(e,f);else{var c=new Rd;K(g,c,!0)}});hc(g,function(a,b,c){f=b;e=a;d=c});return g};
ae.prototype.Z=function(a,b,c,d,e){var f,g,h=new E;wb(h,function(a){g=!1;f=a},function(a){g=!0;f=a});ae.C.Z.call(this,h,b,c,d,function(b,c){if("complete"!=b)a.l(c);else if(!0===g)a.l(f);else if(!1===g)a.callback(f);else{var d=new Rd;a.l(d)}e&&(e(b,c),e=void 0)})};function be(a,b,c){this.c=a;this.b=b;this.a=c;this.f=null}be.prototype.logger=null;be.prototype.g=function(){return this.a.f};be.prototype.abort=function(){this.a.abort()};function V(a){if(!a.f){var b;b=a.c;var c=b.Ga();if("indexeddb"==c)b=new ce(0,b.c);else if("websql"==c||"sqlite"==c)b=new de(0,b.c);else throw new Nb("No executor for "+c);a.f=b}return a.f}
function ee(a,b){var c=x(b)?b:B(b)?b.name:void 0;if(!x(c))throw new F("store name "+c+" must be a string, but "+typeof c);var d=T(a.b,c);if(!d){if(!a.b.a())throw new F('store name "'+c+'" not found.');d=Qc(B(b)?b:{name:c});var e=a.c,f=d,g=f instanceof Pc?f:Qc(f),f=T(e.c,f.name);if(0==dd(g,f).length)(new E).callback(!1);else if(e.c instanceof pd)qd(e.c,g),e.a?(e.a.close(),e.a=null,wd(e)):(new E).callback(!1);else throw new sd("");}else if(a.b.a()&&B(b)&&(e=Qc(b),e=dd(d,e)))throw new Lb(e);if(!d)throw new Od(c);
return d};function W(a,b,c){be.call(this,a,b,c)}C(W,be);l=W.prototype;l.logger=null;
l.count=function(a,b,c,d){var e,f,g,h;if(null!=a)if(t(a)){if(r(c)||r(b))throw new F("too many arguments.");f=a;for(var k=0;k<f.length;k++)if(!nd(this.b,f[k]))throw new F('store name "'+f[k]+'" at '+k+" not found.");Kb("countStores: "+Q(f));e=this.a.request("d",f);L(e,function(){V(this).ua(e,f)},this)}else if(x(a)){k=T(this.b,a);if(!k)throw new F('store name "'+a+'" not found.');f=[a];if(x(b))g=b,B(c)?h=xc(c):h=null;else if(B(b)||null==b)if(B(b))h=xc(b);else{if(null!=b)throw new F("key range must be  an object but found "+
hd(b)+" of type "+typeof b);h=null}else throw new F('invalid second argument for count "'+hd(c)+'" of type '+typeof b);Kb("countKeyRange: "+a+" "+(g?g:"")+Q(h));e=this.a.request("d",f);R(k,e,arguments);L(e,function(){V(this).Oa(e,f[0],h,g,!!d)},this)}else throw new F("Invalid store name or store names.");else k=md(this.b),e=this.a.request("d",k),hc(e,function(a,b,c){if(b)c(a,!0);else{for(var d=b=0;d<a.length;d++)b+=a[d];c(b,!1)}},this),L(e,function(){V(this).ua(e,f)},this);return e};
l.get=function(a,b){var c=this,d;if(a instanceof tc){var e=a,f=e.b,g=T(this.b,f);if(!g){if(this.b.a()){if(zd(this.c))return jc("e",void 0);d=new J("e");this.c.ma(function(){wb(c.get(a,b),function(a){d.callback(a)},function(a){d.l(a)})});return d}throw new F("Store: "+f+" not found.");}var h=e.a;d=this.a.request("ek",[f]);R(g,d,arguments,void 0,this);L(d,function(){V(this).ya(d,f,h)},this)}else if(x(a)&&r(b)){var k=a,g=T(this.b,k);if(!g){if(this.b.a()){if(zd(this.c))return jc("e",void 0);d=new J("e");
this.c.ma(function(){wb(c.get(a,b),function(a){d.callback(a)},function(a){d.l(a)})});return d}throw new F('Store name "'+k+'" not found.');}var n=b;d=this.a.request("e",[k]);R(g,d,arguments,void 0,this);L(d,function(){V(this).ya(d,k,n)},this)}else throw new F("get require valid input arguments.");return d};
l.mb=function(a,b,c,d,e){var f=T(this.b,a),g,h,k,n=null;B(b)&&(n=xc(b));if(r(c))if(z(c))g=c;else throw new F("limit must be a number, but "+c+" is "+typeof c);else g=100;if(r(d))if(z(d))h=d;else throw new F("offset must be a number, but "+d+" is "+typeof d);else h=0;if(r(e))if(ca(e))k=e;else throw new F("reverse must be a boolean, but "+e+" is "+typeof e);var p=this.a.request("g",[a]);R(f,p,arguments);L(p,function(){V(this).Y(p,2,a,null,n,g,h,k,!1)},this);return p};
l.ba=function(a,b,c,d,e,f,g){var h,k,n,p,m,u=T(this.b,a);h=xc(c);if(z(d))k=d;else{if(r(d))throw new F("limit must be a number");k=100}if(z(e))n=e;else{if(r(e))throw new F("offset must be a number");n=0}if(r(f))if(ca(f))p=f;else throw new F("reverse must be a boolean");if(r(g))if(ca(g))m=g;else throw new F("unique must be a boolean");var v=this.a.request("i",[a]);R(u,v,arguments);L(v,function(){V(this).Y(v,2,a,b,h,k,n,p,m)},this);return v};
l.keys=function(a,b,c,d,e,f,g){var h=T(this.b,a);return this.b.a()&&!h?jc("g",[]):x(b)?this.ba(a,b,c,d,e,f,g):this.mb(a,b,c,d,e)};
l.values=function(a,b,c,d,e,f,g){var h=this,k;if(x(a)){var n=a,p=T(this.b,n);if(!p){if(this.b.a()){if(zd(this.c))return jc("s",[]);k=new J("s");this.c.ma(function(){wb(h.values(a,b,c,d,e,f),function(a){k.callback(a)},function(a){k.l(a)})});return k}throw new Od(n);}if(t(b)){var m=b;k=this.a.request("v",[n]);R(p,k,arguments,void 0,this);L(k,function(){V(this).Qa(k,n,m)},this)}else k=x(b)?this.ea(n,b,c,d,e,f,g):this.qb(n,b,c,d,e)}else if(t(a))if(a[0]instanceof tc){for(var p=[],u=a,v=0;v<u.length;v++){var y=
u[v].b;if(!nd(this.b,y)){if(this.b.a())return p=[],p[u.length-1]=void 0,jc("e",p);throw new F("Store: "+y+" not found.");}0<=Aa(p,y)||p.push(y)}Kb("listByKeys: "+Q(p)+" "+u.length+" keys");k=this.a.request("w",p);L(k,function(){V(this).Ra(k,u)},this)}else throw new F("first argumentmust be array of ydn.db.Key, but "+a[0]+" of "+typeof a[0]+" found.");else throw new F("first argument "+a+" is invalid.");return k};
l.qb=function(a,b,c,d,e){var f=T(this.b,a),g,h,k,n=null;B(b)&&(n=xc(b));if(r(c))if(z(c))g=c;else throw new F("limit must be a number, but "+c+" is "+typeof c);else g=100;if(r(d))if(z(d))h=d;else throw new F("offset must be a number, but "+d+" is "+typeof d);else h=0;if(r(e))if(ca(e))k=e;else throw new F("reverse must be a boolean, but "+e+" is "+typeof e);var p=this.a.request("s",[a]);R(f,p,arguments);L(p,function(){V(this).Y(p,4,a,null,n,g,h,k,!1)},this);return p};
l.ea=function(a,b,c,d,e,f,g){var h=T(this.b,a),k,n,p,m,u=xc(c);if(r(d))if(z(d))k=d;else throw new F("limit must be a number.");else k=100;if(r(e))if(z(e))n=e;else throw new F("offset must be a number.");else n=0;if(ca(f))p=f;else if(r(f))throw new F("reverse must be a boolean, but "+f);if(r(g))if(ca(g))m=g;else throw new F("unique must be a boolean");var v=this.a.request("u",[a]);R(h,v,arguments);L(v,function(){V(this).Y(v,4,a,b,u,k,n,p,m)},this);return v};
l.add=function(a,b,c){if(t(b))return this.fa(a,b,c);a=ee(this,a);var d=a.getName(),e;if(x(a.keyPath)&&r(c))throw new F("key must not be provided while the store uses in-line key.");if(!a.keyPath&&!a.b&&!r(c))throw new F("out-of-line key must be provided for store: "+d);if(t(b)){for(var f=0;f<b.length;f++)ed(a,b[f]);e=this.a.request("b",[d],I);L(e,function(){V(this).K(e,!1,!1,d,b,c)},this);a.J&&e.w(function(){},this)}else if(B(b))ad(a,b,c),ed(a,b),e=this.a.request("a",[d],I),L(e,function(){V(this).K(e,
!1,!0,d,[b],[c])},this),a.J&&e.w(function(){},this);else throw new F("record must be an object or array list of objects, but "+b+" of type "+typeof b+" found.");return e};
l.fa=function(a,b,c){a=ee(this,a);var d=a.getName(),e;if(x(a.keyPath)&&r(c))throw new F("key must not be provided while the store uses in-line key.");if(!a.keyPath&&!a.b&&!r(c))throw new F("out-of-line key must be provided for store: "+d);if(t(b)){for(var f=0;f<b.length;f++)ed(a,b[f]);e=this.a.request("b",[d],I);L(e,function(){V(this).K(e,!1,!1,d,b,c)},this);a.J&&e.w(function(){},this)}else throw new F("record must be an array list of objects, but "+b+" of type "+typeof b+" found.");return e};
l.put=function(a,b,c){var d,e=this;if(a instanceof tc){var f=a,g=f.b,h=T(this.b,g);if(!h)throw new F('store "'+g+'" not found.');if(h.keyPath){var k=ad(h,b);if(null!=k){if(0!=O(k,f.a))throw new F("Inline key must be "+f+" but "+k+" found.");}else bd(h,b,f.a);return this.put(g,b)}return this.put(g,b,f.a)}if(t(a)){for(var n=a,p=b,f=[],g=0,h=n.length;g<h;g++){k=n[g].b;-1==Aa(f,k)&&f.push(k);var m=T(this.b,k);if(!m)throw new F('store "'+k+'" not found.');m.keyPath&&bd(m,p[g],n[g].a)}Kb("putByKeys: to "+
Q(f)+" "+p.length+" objects");for(g=0;g<p.length;g++)ed(m,p[g]);d=this.a.request("l",f,I);R(m,d,arguments);L(d,function(){V(e).Ua(d,p,n)},this)}else if(x(a)||B(a)){var m=ee(this,a),u=m.getName();if(m.keyPath&&r(c))throw new F("key must not be provided while the store uses in-line key.");if(!m.keyPath&&!m.b&&!r(c))throw new F("out-of-line key must be provided for store: "+u);if(t(b)){for(var v=b,y=c,g=0;g<v.length;g++)ed(m,v[g]);d=this.a.request("k",[u],I);R(m,d,arguments);L(d,function(){V(this).K(d,
!0,!1,u,v,y)},this);m.J&&d.w(function(){},this)}else if(B(b)){var A=b,S=c;if(r(q.Blob)&&A instanceof Blob&&m.T&&!m.keyPath&&0==m.a.length&&Hb)d=new J("j"),f=new FileReader,f.onload=function(a){var b=a.target.result,c=e.a.request("j",[u],I);R(m,c,[u,A,S]);L(c,function(){V(e).K(c,!0,!0,u,[b],[S])},this);wb(c,function(a){d.callback(a)},function(a){d.l(a)})},f.onerror=function(a){d.l(a)},f.onabort=function(a){d.l(a)},f.readAsDataURL(A);else{ed(m,A);d=this.a.request("j",[u],I);var X=[u,A,S];R(m,d,X);L(d,
function(){var a=r(S)?[X[2]]:void 0;V(e).K(d,!0,!0,u,[X[1]],a)},this)}m.J&&d.w(function(){},this)}else throw new F("put record value must be Object or array of Objects");}else throw new F("the first argument of put must be store name, store schema or array of keys.");return d};
l.na=function(a,b,c){var d,e=ee(this,a),f=e.getName();if(e.keyPath&&r(c))throw new F("key must not be provided while the store uses in-line key.");if(!e.keyPath&&!e.b&&!r(c))throw new F("out-of-line key must be provided for store: "+f);for(var g=b,h=c,k=0;k<g.length;k++)ed(e,g[k]);d=this.a.request("k",[f],I);R(e,d,arguments);L(d,function(){V(this).K(d,!0,!1,f,g,h)},this);e.J&&d.w(function(){},this);return d};
l.clear=function(a,b){var c;if(x(a)){var d=T(this.b,a);if(!d)throw new F('store name "'+a+'" not found.');if(B(b)){var e=xc(b);if(null===e)throw new F("clear method requires a valid non-null KeyRange object.");Kb("clearByKeyRange: "+a+":"+Q(e));c=this.a.request("c",[a],I);R(d,c,[a,e]);L(c,function(){V(this).Ma(c,a,e)},this)}else{if(r(b))throw new F("clear method requires a valid KeyRange object as second argument, but found "+b+" of type "+typeof b);c=this.a.request("c",[a],I);L(c,function(){V(this).sa(c,
[a])},this)}}else if(!r(a)||t(a)&&x(a[0])){var f=a||md(this.b);Kb("clearByStores: "+Q(f));c=this.a.request("c",f,I);L(c,function(){V(this).sa(c,f)},this)}else throw new F('first argument "'+a+'" is invalid.');return c};
...
[a],I);var h=[a,b];R(e,d,h);L(d,function(){V(this).Ca(d,a,h[1])},this);e.J&&d.w(function(){},this)}else if(B(b))g=xc(b),Kb("removeByKeyRange: "+a+":"+Q(g)),d=this.a.request("n",[a],I),R(e,d,[a,g]),L(d,function(){V(this).Wa(d,a,g)},this),e.J&&d.w(function(){},this);else throw new F('Invalid key or key range "'+b+'" of type '+typeof b);}else if(a instanceof tc){var k=a.b,e=T(this.b,k);d=this.a.request("m",[k],I);var n=[k,a.a];R(e,d,n);L(d,function(){V(this).Ca(d,k,n[1])},this)}else if(t(a)){b=[];c=
0;for(e=a.length;c<e;c++){var p=a[c].b;-1==Aa(b,p)&&b.push(p)}if(1>b.length)throw new F('at least one valid key required in key list "'+hd(a)+'"');d=this.a.request("o",b,I);L(d,function(){V(this).Xa(d,a)},this)}else throw new F('first argument requires store name, key (ydn.db.Key) or list of keys (array) , but "'+hd(a)+'" ('+ba(a)+") found.");return d};function fe(a,b,c){be.call(this,a,b,c)}C(fe,W);l=fe.prototype;l.logger=null;l.get=function(a,b){if(a instanceof Fd){var c=a.b,d=T(this.b,c);if(!d)throw new F('store "'+c+'" not found.');var e=a.f;if(r(e)&&!Yc(d,e))throw new F('index "'+e+'" not found in store "'+c+'".');var f=this.a.request("f",[c]);L(f,function(){ge(this,5,f,a,1)},this);return f}return fe.C.get.call(this,a,b)};
l.Ba=function(a,b){var c=100;if(z(b)){if(c=b,1>c)throw new F("limit must be a positive value, but "+b);}else if(r(b))throw new F("limit must be a number,  but "+b);var d=this.a.request("h",[a.b]);L(d,function(){a.v?ge(this,1,d,a,c):ge(this,2,d,a,c)},this);return d};l.keys=function(a,b,c,d,e,f,g){return a instanceof Fd?this.Ba(a,b):fe.C.keys.call(this,a,b,c,d,e,f,g)};l.ta=function(a){var b=this.a.request("d",[a.b]);L(b,function(){ge(this,6,b,a)},this);return b};
l.count=function(a,b,c,d){if(a instanceof Fd){if(r(b)||r(c))throw new F("too many arguments.");return this.ta(a)}return fe.C.count.call(this,a,b,c,d)};l.Da=function(a,b){var c;if(z(b)){if(c=b,1>c)throw new F("limit must be a positive value, but "+c);}else if(r(b))throw new F("limit must be a number, but "+b);var d=this.a.request("t",[a.b]);L(d,function(){a.c?ge(this,2,d,a,c):ge(this,4,d,a,c)},this);return d};
l.values=function(a,b,c,d,e,f){return a instanceof Fd?this.Da(a,b):fe.C.values.call(this,a,b,c,d,e,f)};
function he(a,b,c){var d,e=I||G,f=[];for(d=0;d<c.length;d++)for(var g=c[d].stores(),h=0;h<g.length;h++)0<=Aa(f,g[h])||f.push(g[h]);d=a.a.request("qa",f);a.a.Z(d,function(d,e,f){function g(){for(var b=0,f=0;f<c.length;f++){var m=c[f],p=[V(a).b(d,e,m.b)],m=m.load(p);m.R=h;m.I=ja(v,b);H[f]=m;S[b]=f;b++}A=c.length}function h(a){for(var b=0;b<H.length;b++)Dd(H[b]);Fa(H);f(a,!0)}function v(a,d){if(y)throw new rd;N++;var e=N===A,g=S[a],h=c[g],k=H[g],g=k.O(),k=k.pa();X[a]=d;M[a]=h.v?h.c?g:k:h.c?d:k;if(e){var n;
b instanceof Kd?n=b.c(X,M):n=b(X,M);e=[];h=[];g=[];k=[];if(t(n))for(var m=0;m<n.length;m++)!0===n[m]?g[m]=1:!1===n[m]?k[m]=!0:h[m]=n[m];else if(null===n)e=[];else if(r(n))if(B(n))e=n.continuePrimary||[],h=n["continue"]||[],g=n.advance||[],k=n.restart||[];else throw new Mb("scan callback output");else for(e=[],m=0;m<c.length;m++)r(S[m])&&(g[m]=1);for(m=N=n=0;m<c.length;m++)null!=e[m]||r(h[m])||null!=k[m]||null!=g[m]||N++;for(m=0;m<c.length;m++)if(null!=e[m]||r(h[m])||null!=k[m]||null!=g[m]){var u=
S[m];if(!r(u))throw new td(m+" is not an iterator.");var u=c[u],v=H[m];X[m]=void 0;M[m]=void 0;if(null!=k[m])u=v,u.j=!1,u.s=!1,u.openCursor(void 0,void 0);else if(r(h[m]))v.X(h[m]);else if(null!=e[m])v.oa(e[m]);else if(null!=g[m])v.advance(1);else throw new rd(u+": has no action");n++}if(0==n){for(n=0;n<H.length;n++)Dd(H[n]);y=!0;Fa(H);f(void 0)}}}var y=!1,A,S=[],X=[],M=[],H=[],N=0;b instanceof Kd?Ld(b,c)||g():g()},f,e);return d}
l.open=function(a,b,c,d){c=c||G;var e=this,f=this.a.request("i5",b.stores(),c);L(f,function(c){for(var h=ic(f),k=b.stores(),n=[],p=0;p<k.length;p++)n[p]=V(e).b(c,h,k[p]);var m=b.load(n);m.R=function(a){K(f,a,!0)};m.I=function(b){if(null!=b){var c=a.call(d,m);!0===c?(m.j=!1,m.s=!1,m.openCursor(void 0,void 0)):B(c)?!0===c.restart?(b=c["continue"],c=c.continuePrimary,m.j=!1,m.s=!1,m.openCursor(c,b)):null!=c["continue"]?m.X(c["continue"]):null!=c.continuePrimary?m.oa(c.continuePrimary):(Dd(m),K(f,void 0)):
null===c?(Dd(m),K(f,void 0)):null!=c?m.X(c):m.advance(1)}else Dd(m),K(f,void 0)}},this);return f};function ie(a,b,c,d){var e=c.b,f=c.f||null,g=d||100,h=a.a.request("u",[e]),k="done"==c.g||c.g==Gd?[]:[c.j,c.m];L(h,function(){V(this).Y(h,b,e,f,c.a?c.a instanceof Dc?c.a:Dc.bound(c.a.lower,c.a.upper,c.a.lowerOpen,c.a.upperOpen):null,g,0,Hd(c),Id(c),k)},a);h.w(function(){null!=k[0]?c.reset("rest",k[0],k[1]):c.reset()});return h}
function ge(a,b,c,d,e){var f=[],g=c.a,h=ic(c);a=V(a);for(var k=[],n=d.stores(),p=0;p<n.length;p++)k[p]=a.b(g,h,n[p]);var m=d.load(k);m.R=function(a){Dd(m);K(c,a,!0)};var u=0,v=!1;m.I=function(a){v||(v=!0);null!=a?(m.O(),u++,1==b?f.push(a):2==b?f.push(m.O()):3==b?f.push([a,m.O()]):6!=b&&f.push(m.pa()),5==b?(Dd(m),K(c,f[0])):6==b||!r(e)||u<e?m.X():(Dd(m),K(c,f))):(Dd(m),K(c,5==b?f[0]:6==b?u:f))}};function je(a,b,c,d){this.f=a;this.a=Ga(c);this.b=d;this.c=[]}je.prototype.f=null;function ke(a,b,c){if(a.f)c&&a.c.push(c),b(a.f);else throw new Nb("tx committed on ParallelTxExecutor");};function le(a,b,c,d,e,f){Vd.call(this,a,b,c,d,e,f);this.c=this.b=null}C(le,Vd);l=le.prototype;l.logger=null;l.abort=function(){Xd(this.c)};
l.eb=function(a,b){var c;if("multi"==this.h)a:if(c=this.b,!c.a||!c.b||b!=c.b&&(c.b!=I||b!=G)||a.length>c.a.length)c=!1;else{for(var d=0;d<a.length;d++)if(-1==c.a.indexOf(a[d])){c=!1;break a}c=!0}else if("repeat"==this.h)a:if(c=this.b,c.a&&c.b&&b==c.b&&c.a.length==a.length){for(d=0;d<a.length;d++)if(-1==c.a.indexOf(a[d])){c=!1;break a}c=!0}else c=!1;else c="all"==this.h?!0:!1;return c};
...
l.openCursor=function(a,b){function c(a,b,c){m.b=p;m.b.onsuccess=ia(m.ha,m);m.L(a,m.g?b:void 0,c);p=null}var d=this.S,e=this.m.objectStore(this.hb),f=x(this.i)?e.index(this.i):null;if(r(a))var g=f?!r(b):!0,h=d?d.lower:void 0,k=d?d.upper:void 0,n=d?!!d.lowerOpen:!1,d=d?!!d.upperOpen:!1,d=wc(this.reverse?new P(h,a,n,g):new P(a,k,g,d));var p;this.ka?f?p=null!=this.dir?f.openKeyCursor(d,this.dir):null!=d?f.openKeyCursor(d):f.openKeyCursor():p=null!=this.dir?e.openCursor(d,this.dir):null!=d?e.openCursor(d):
e.openCursor():f?p=null!=this.dir?f.openCursor(d,this.dir):null!=d?f.openCursor(d):f.openCursor():p=null!=this.dir?e.openCursor(d,this.dir):null!=d?e.openCursor(d):e.openCursor();var m=this;p.onerror=function(a){var b=p.error;a.preventDefault();Bd(m,b)};null!=a?p.onsuccess=function(d){if(d=d.target.result){var e=Sb.cmp(d.key,a),f=m.reverse?-1:1;if(e==f)c(d.key,d.primaryKey,d.value);else if(e==-f)d["continue"](a);else if(null!=b)if(Sb.cmp(d.primaryKey,b)==f)c(d.key,d.primaryKey,d.value);else d["continue"]();
else d["continue"]()}else c()}:(m.b=p,m.b.onsuccess=ia(m.ha,m))};l.Aa=function(){return!!this.b};l.update=function(a){var b=this.b.result;if(b){var c=new E;a=b.update(a);a.onsuccess=function(a){c.callback(a.target.result)};a.onerror=function(a){a.preventDefault();c.l(a)};return c}throw new Nd("cursor gone");};
l.clear=function(){var a=this.b.result;if(a){var b=new E,a=a["delete"]();a.onsuccess=function(){b.callback(1)};a.onerror=function(a){a.preventDefault();b.l(a)};return b}throw new Nd("cursor gone");};l.advance=function(a){var b=this.b.result;if(1==a)b["continue"]();else b.advance(a)};
l.oa=function(a){var b,c=this.b.result,d=this;this.b.onsuccess=function(e){if(c=e.target.result)if(b=Sb.cmp(c.primaryKey,a),0==b||1==b&&!d.reverse||-1==b&&d.reverse)d.b.onsuccess=ia(d.ha,d),d.L(c.key,d.g?c.primaryKey:void 0,c.value);else c["continue"]();else d.b.onsuccess=ia(d.ha,d),d.L()};c["continue"]()};l.X=function(a){var b=this.b.result;if(null!=a)b["continue"](a);else b["continue"]()};function re(a,b){this.a=b}C(re,Sd);l=re.prototype;l.logger=null;l.ua=function(a,b){function c(e){var f=a.a.objectStore(b[e]).count();f.onsuccess=function(f){d[e]=f.target.result;e++;e==b.length?K(a,d):c(e)};f.onerror=function(b){b.preventDefault();K(a,f.error,!0)}}var d=[];0==b.length?K(a,[]):c(0)};
l.K=function(a,b,c,d,e,f){function g(d){if(null==e[d])if(k++,k==e.length)K(a,h,n);else{var u=d+10;u<e.length&&g(u)}var v,u=e[d];v=f&&null!=f[d]?b?p.put(u,f[d]):p.add(u,f[d]):b?p.put(u):p.add(u);v.onsuccess=function(b){k++;h[d]=b.target.result;k==e.length?K(a,c?h[0]:h,n):(b=d+10,b<e.length&&g(b))};v.onerror=function(b){k++;var f=v.error;hd(e[d]);h[d]=f;n=!0;b.preventDefault();k==e.length?K(a,c?h[0]:h,n):(b=d+10,b<e.length&&g(b))}}var h=[],k=0,n=!1,p=a.a.objectStore(d);if(0<e.length)for(d=0;10>d&&d<
e.length;d++)g(d);else K(a,[])};l.Ua=function(a,b,c){function d(h){var n=c[h],p=a.a.objectStore(n.b),m;m=null===p.keyPath?p.put(b[h],n.a):p.put(b[h]);m.onsuccess=function(c){f++;e[h]=c.target.result;f==b.length?K(a,e,g):(c=h+10,c<b.length&&d(c))};m.onerror=function(c){f++;e[h]=m.error;g=!0;c.preventDefault();f==b.length?K(a,e,g):(c=h+10,c<b.length&&d(c))}}var e=[],f=0,g=!1;if(0<b.length)for(var h=0;10>h&&h<b.length;h++)d(h);else K(a,e,g)};
l.Ca=function(a,b,c){var d=a.a.objectStore(b).openCursor(Dc.only(c));d.onsuccess=function(b){if(b=b.target.result){var c=b["delete"]();c.onsuccess=function(){K(a,1)};c.onerror=function(){K(a,c.error,!0)}}else K(a,0)};d.onerror=function(b){b.preventDefault();K(a,d.error,!0)}};
l.Xa=function(a,b){function c(h){h++;if(h>=b.length)0<g.length?K(a,g,!0):K(a,d);else{b[h].b!=e&&(e=b[h].b,f=a.a.objectStore(e));var k=f["delete"](b[h].a);k.onsuccess=function(){d++;c(h)};k.onerror=function(a){a.preventDefault();g[h]=k.error;c(h)}}}var d=0,e,f,g=[];c(-1)};
l.Wa=function(a,b,c){var d=a.a.objectStore(b),e=d.count(c);e.onsuccess=function(b){var e=b.target.result,h=d["delete"](c);h.onsuccess=function(){K(a,e)};h.onerror=function(){K(a,h.error,!0)}};e.onerror=function(b){b.preventDefault();K(a,e.error,!0)}};l.Ma=function(a,b,c){var d=a.a.objectStore(b)["delete"](c);d.onsuccess=function(){K(a,void 0)};d.onerror=function(b){b.preventDefault();K(a,d.error,!0)}};
l.Va=function(a,b,c,d){var e=[],f=a.a.objectStore(b).index(c).openCursor(d),g=0;f.onsuccess=function(b){var c=b.target.result;if(c){var d=c["delete"]();d.onsuccess=function(){g++;c["continue"]()};d.onerror=function(a){e.push(d.error);a.preventDefault();c["continue"]()}}else 0<e.length?K(a,e,!0):K(a,g)};f.onerror=function(b){b.preventDefault();K(a,f.error,!0)}};
l.sa=function(a,b){for(var c=b.length,d=0,e=0;e<c;e++){var f=a.a.objectStore(b[e]).clear();f.onsuccess=function(){d++;d==c&&K(a,d)};f.onerror=function(b){d++;b.preventDefault();d==c&&K(a,f.error,!0)}}};
l.ya=function(a,b,c){var d=a.a.objectStore(b),e=d.get(c);e.onsuccess=function(b){var c=b.target.result;if(!d.keyPath&&0==d.indexNames.length&&Hb&&x(c)&&0<=c.indexOf(";base64,")){'"'==c.charAt(0)&&'"'==c.charAt(c.length-1)&&(c=c.substr(1,c.length-2));c=c.split(";base64,");b=c[0].split(":")[1];for(var c=window.atob(c[1]),e=c.length,k=new Uint8Array(e),n=0;n<e;++n)k[n]=c.charCodeAt(n);K(a,new Blob([k.buffer],{type:b}))}else K(a,b.target.result)};e.onerror=function(b){b.preventDefault();K(a,e.error,!0)}};
l.Qa=function(a,b,c){function d(b){if(null==c[b])if(f++,e[b]=void 0,f==h)K(a,e);else{var n=b+10;n<h&&d(n)}var p;p=g.get(c[b]);p.onsuccess=function(c){f++;e[b]=c.target.result;f==h?K(a,e):(c=b+10,c<h&&d(c))};p.onerror=function(b){f++;b.preventDefault();K(a,p.error,!0)}}var e=[];e.length=c.length;var f=0,g=a.a.objectStore(b),h=c.length;if(0<h)for(b=0;10>b&&b<h;b++)d(b);else K(a,[])};
l.Ra=function(a,b){function c(f){var h=b[f],k=a.a.objectStore(h.b).get(h.a);k.onsuccess=function(h){e++;d[f]=h.target.result;e==b.length?K(a,d):(h=f+10,h<b.length&&c(h))};k.onerror=function(b){e++;b.preventDefault();K(a,k.error,!0)}}var d=[];d.length=b.length;var e=0;if(0<b.length)for(var f=0;10>f&&f<b.length;f++)c(f);else K(a,[])};
...
function te(a,b,c,d){var e=b.getAllKeys(c,d);e.onsuccess=function(b){K(a,b.target.result)};e.onerror=function(b){b.preventDefault();K(a,e.error,!0)}}
...
g.keyPath),h++)}for(f=0;f<e.length;f++)Yc(c,e[f])||(b.deleteIndex(e[f]),k++)}else for(b=d(),f=0;f<c.a.length;f++)g=c.index(f),"BLOB"!=g.type&&(g.unique||g.multiEntry?(p={unique:g.unique,multiEntry:g.multiEntry},b.createIndex(g.getName(),g.keyPath,p)):b.createIndex(g.getName(),g.keyPath))}
l.wa=function(a,b,c,d){var e=this.u;if(!b){b=[];for(var f=e.objectStoreNames.length-1;0<=f;f--)b[f]=e.objectStoreNames[f]}0==b.length?a(null):(b=e.transaction(b,c),b.oncomplete=function(a){d("complete",a)},b.onabort=function(a){d("abort",a)},a(b),a=null)};l.close=function(){this.u.close()};kc.push(function(a,b){if(!Sb||b&&"indexeddb"!=b)return null;var c=Sb.deleteDatabase(a),d=new J("vc");c.onblocked=function(a){Pb(d,a)};c.onerror=function(a){d.l(a)};c.onsuccess=function(a){d.callback(a)};return d});function De(a,b){this.a=r(a)?a:4194304;this.b=b||"websql"}l=De.prototype;
l.connect=function(a,b){function c(a,b){var c=a.version?parseInt(a.version,10):0,f=!1,g=0;a.changeVersion(a.version,(b.b?isNaN(c)?1:c+1:b.version)+"",function(c){e.N(function(a){f=!0;for(var d=0;d<b.count();d++){var e=T(a,(b.stores[d]||null).getName()),e=e?Zc(e,b.stores[d]||null):null;Ee(c,b.stores[d]||null,function(a){a&&g++},e)}for(e=0;e<a.count();e++)if(d=a.stores[e]||null,!nd(b,d.getName()))if(b instanceof pd)qd(b,d);else for(var h=Fe(d),d=0;d<h.length;d++)c.executeSql(h[d],[],function(){},function(a,
b){throw b;})},c,a)},function(a){throw a;},function(){f&&d(a)})}function d(a,b){r(b)?(e.B=null,g.l(b)):(e.B=a,g.callback(parseFloat(f)))}var e=this,f=NaN,g=new E,h=null;try{"sqlite"==this.b?q.sqlitePlugin?(h=q.sqlitePlugin.openDatabase(a,"",a,this.a),h.readTransaction||(h.readTransaction=h.transaction),h.changeVersion=function(a,b,c,d,e){h.transaction(c,d,e)}):(h=null,this.la=Error("sqlitePlugin not found.")):h=q.openDatabase(a,"",a,this.a)}catch(k){if("SECURITY_ERR"==k.name)h=null,this.la=new Qd(k);
else throw k;}h?(f=h.version||"",null!=b.version&&b.version==h.version?d(h):this.N(function(a){od(b,a,!0,!1)?c(h,b):d(h)},null,h)):d(null,this.la);return g};l.$a=function(){return this.b};l.la=null;l.B=null;l.Za=function(){return this.B||null};l.logger=null;l.Fa=function(){};l.bb=function(){};
function Fe(a){var b=[];b.push("DROP TABLE IF EXISTS "+ta(a.getName()));for(var c=0,d=a.a.length;c<d;c++){var e=a.index(c);e.multiEntry&&(e="DROP TABLE IF EXISTS "+ta("ydn.db.me:"+a.getName()+":"+e.getName()),b.push(e))}return b}
function Ge(a){var b=a.m,c="CREATE TABLE IF NOT EXISTS "+Uc(a)+" (",d=a.c,c=c+(d+" "+b+" PRIMARY KEY ");a.b&&(c+=" AUTOINCREMENT ");if(!a.T||!a.keyPath&&0==a.a.length)c+=" ,_default_ BLOB";for(var e=[],f=[d],g=0,h=a.a.length;g<h;g++){var k=a.index(g),n="";if(k.multiEntry)n=k.unique?" UNIQUE ":"",k="CREATE TABLE IF NOT EXISTS "+ta("ydn.db.me:"+a.getName()+":"+k.getName())+" ("+d+" "+b+", "+k.c+" "+k.i+n+")",e.push(k);else{k.unique&&(n=" UNIQUE ");var p=k.c;-1==f.indexOf(p)&&(c+=", "+p+" "+k.i+n,f.push(p))}}e.unshift(c+
")");return e}l.ab=function(){return this.B?parseFloat(this.B.version):void 0};
l.N=function(a,b,c){function d(a,b){throw b;}function e(b,c){if(c&&c.rows){for(var d=0;d<c.rows.length;d++){var e=c.rows.item(d);if("__WebKitDatabaseInfoTable__"!=e.name&&"sqlite_sequence"!=e.name&&"table"==e.type){var f=null!==e&&"sql"in e?e.sql:void 0,v=f.substr(f.indexOf("("),f.lastIndexOf(")")).match(/(?:"[^"]*"|[^,])+/g),y=void 0,A,f=[],S=!1,X=!1,M=0;for(;M<v.length;M++){var H=v[M].match(/\w+|"[^"]+"/g),N=Ba(H,function(a){return a.toUpperCase()}),ma=qa(H[0]),H=Jc(N[1]);if(-1!=N.indexOf("PRIMARY")&&
-1!=N.indexOf("KEY")){A=H;if(x(ma)&&!/^[\s\xa0]*$/.test(ma)&&"_ROWID_"!=ma){var kb=ma.split(","),y=ma;1<kb.length&&(y=kb,A=void 0)}-1!=N.indexOf("AUTOINCREMENT")&&(S=!0)}else if("_ROWID_"!=ma)if("_default_"==ma)X=!0;else{var lb="UNIQUE"==N[2];0==ma.lastIndexOf(e.tbl_name+"-",0)&&(ma=ma.substr(e.tbl_name.length+1));N=new Ic(ma,H,lb);f.push(N)}}if(0==e.name.lastIndexOf("ydn.db.me:",0)){if(y=e.name.split(":"),3<=y.length){var dc=y[1],Ta=y[2],y=new Ic(Ta,H,lb,!0),v=Ea(h,function(a){return a.getName()===
dc});0<=v?(M=h[v],N=fd(M,Ta),0<=N?f[N]=y:(N=Ea(f,function(a){return a.getName()==Ta}),0<=N?f[N]=y:f.push(y)),h[v]=new Pc(M.getName(),M.keyPath,S,A,f,void 0,!X)):h.push(new Pc(dc,void 0,!1,void 0,[y]))}}else if(v=Ea(h,function(a){return a.getName()===e.name}),0<=v){for(d=0;d<h[v].a.length;d++){var M=h[v].index(d),Ne=M.getName();-1==Ea(f,function(a){return a.getName()==Ne})&&f.push(M)}h[v]=new Pc(e.name,y,S,A,f,void 0,!X)}else f=new Pc(e.name,y,S,A,f,void 0,!X),h.push(f)}}d=new ld(g,h);a(d)}}var f=
this,g=(c=c||this.B)&&c.version?parseFloat(c.version):void 0,g=isNaN(g)?void 0:g,h=[];b?b.executeSql("SELECT * FROM sqlite_master",[],e,d):c.readTransaction(function(b){f.N(a,b,c)},function(a){throw a;},e)};function Ee(a,b,c,d){function e(b){a.executeSql(b,[],function(){f++;f==g.length&&(c(!0),c=null)},function(a,b){f++;f==g.length&&(c(!1),c=null);throw new Pd(b,'"');})}var f=0,g=Ge(b);if(d){if(0==dd(b,d).length){c(!0);c=null;return}g.unshift.apply(g,Fe(d))}for(b=0;b<g.length;b++)e(g[b])}l.Ea=function(){return!!this.B};
l.close=function(){this.B=null};l.wa=function(a,b,c,d){function e(a){d("abort",a)}function f(){d("complete",{type:"complete"})}function g(b){a(b)}null===this.B&&(a(null),d("abort",this.la));c==G?this.B.readTransaction(g,e,f):c==Rb?this.B.changeVersion(this.B.version,this.B.version+1+"",g,e,f):this.B.transaction(g,e,f)};
kc.push(function(a,b){if(da(q.openDatabase)&&(!b||"websql"==b)){var c=new De,d=new pd,d=c.connect(a,d),e=function(){};d.w(function(){c.wa(function(a){a.executeSql('SELECT * FROM sqlite_master WHERE type = "table"',[],function(b,c){if(c&&c.rows)for(var d=c.rows.length,e=0,p=0;p<d;p++){var m=c.rows.item(p);"__WebKitDatabaseInfoTable__"!=m.name&&"sqlite_sequence"!=m.name&&(e++,a.executeSql("DROP TABLE "+m.name))}},function(a,b){throw b;})},[],I,e)});d.Ja(function(){})}});De.prototype.Ta=function(){};ne.prototype.va=function(a){return"indexeddb"==a&&Sb?new Be(0,this.v):"sqlite"==a&&q.sqlitePlugin?new De(this.m,"sqlite"):"websql"==a&&da(q.openDatabase)?new De(this.m):null};ne.prototype.branch=ne.prototype.fb;ne.prototype.getTxNo=ne.prototype.yb;be.prototype.getTxNo=be.prototype.g;ne.prototype.run=ne.prototype.ob;Y.prototype.branch=Y.prototype.fb;Y.prototype.add=Y.prototype.add;Y.prototype.addAll=Y.prototype.fa;Y.prototype.get=Y.prototype.get;Y.prototype.keys=Y.prototype.keys;Y.prototype.keysByIndex=Y.prototype.ba;Y.prototype.values=Y.prototype.values;Y.prototype.valuesByIndex=Y.prototype.ea;Y.prototype.put=Y.prototype.put;Y.prototype.putAll=Y.prototype.na;Y.prototype.clear=Y.prototype.clear;Y.prototype.remove=Y.prototype.qa;Y.prototype.count=Y.prototype.count;W.prototype.add=W.prototype.add;
W.prototype.addAll=W.prototype.fa;W.prototype.get=W.prototype.get;W.prototype.keys=W.prototype.keys;W.prototype.keysByIndex=W.prototype.ba;W.prototype.values=W.prototype.values;W.prototype.valuesByIndex=W.prototype.ea;W.prototype.put=W.prototype.put;W.prototype.putAll=W.prototype.na;W.prototype.clear=W.prototype.clear;W.prototype.remove=W.prototype.qa;W.prototype.count=W.prototype.count;la("ydn.db.Key",tc);tc.prototype.id=tc.prototype.jb;tc.prototype.parent=tc.prototype.sb;
tc.prototype.storeName=tc.prototype.tb;la("ydn.db.KeyRange",P);P.upperBound=Ac;P.lowerBound=Bc;P.bound=zc;P.only=yc;P.starts=Cc;pc.prototype.store_name=pc.prototype.b;pc.prototype.getStoreName=pc.prototype.a;function He(a,b,c){Y.call(this,a,b,c)}C(He,pe);la("ydn.db.Storage",He);function Ie(a,b,c){this.db=a;this.b=b;this.type=c||0;this.c=null};function Je(a,b){Kd.call(this,a,b)}C(Je,Kd);
Je.prototype.c=function(a,b){var c=[],d=b[0];if(null==d)return[];for(var e=!0,f=!1,g=d,h=[],k=1;k<a.length;k++)if(null!=b[k]){var n=O(d,b[k]);h[k]=n;this.a?-1==n?e=!1:1==n&&(e=!1,f=!0,-1==O(b[k],g)&&(g=b[k])):1==n?e=!1:-1==n&&(e=!1,f=!0,1==O(b[k],g)&&(g=b[k]))}else e=!1,f=!0;if(e)for(f=0;f<a.length;f++)null!=b[f]&&(c[f]=!0);else if(f)for(f=0;f<a.length;f++)null!=b[f]&&(this.a?-1==O(g,b[f])&&(c[f]=g):1==O(g,b[f])&&(c[f]=g));else for(k=this.a?-1:1,f=1;f<a.length;f++)h[f]===k&&(c[f]=d);return e?(this.b&&
this.b.push(g),c):{continuePrimary:c}};function Ke(a,b){Kd.call(this,a,b)}C(Ke,Kd);Ke.prototype.logger=null;
Ke.prototype.c=function(a,b){function c(a,b){var c=a.slice(0,a.length-1);c.push(b);return c}function d(a){return a[a.length-1]}var e=[];if(0==a.length||null==a[0]||null==a[0])return[];for(var f=!0,g=0,h=d(a[g]),k=[],n=1;n<a.length;n++)if(null!=a[n]){var p=d(a[n]),m=O(h,p);k[n]=m;this.a?-1==m?f=!1:1==m&&(f=!1,h=p,g=1):1==m?f=!1:-1==m&&(f=!1,h=p,g=1)}else return[];n=this.a?-1:1;if(f){for(f=0;f<a.length;f++)null!=a[f]&&(e[f]=!0);this.b&&this.b.push(b[0]);return null!=this.f&&this.b.length>=this.f?[]:
e}if(0==g)for(f=1;f<a.length;f++)k[f]==n&&(e[f]=c(a[f],h));else for(f=0;f<a.length;f++)f!=g&&null!=a[f]&&O(h,d(a[f]))===n&&(e[f]=c(a[f],h));return{"continue":e}};function Le(a,b,c,d){this.c=a;this.a=b||null;this.h=!!c;this.g=!!d;this.b=[];this.f=[]}function Me(a,b){for(var c=b.length-1;0<=c;c--)if(b[c]==a.b[a.b.length-1])b=b.slice(0,c);else break;a.f=b;if(a.a&&a.b[0]){if(a.a.lower!=a.a.upper)throw new Md("Ordering no allowed with range query");a.a=Cc([a.a.lower])}return null}
function Oe(a,b){if((0!=a.b.length||0!=a.f.length)&&Pe(a)&&!Qe(a))throw new Md('Require index "'+a.b.concat(a.f).join(", ")+'" not found in store "'+a.c.getName()+'"');var c=new Fd(a.c.getName(),Re(a),a.a,a.h,a.g,!b);c.s=a.b.length;return c}Le.prototype.clone=function(){var a=new Le(this.c,this.a,this.h,this.g);a.f=this.f.slice();a.b=this.b.slice();return a};function Qe(a){var b=a.b.concat(a.f),c=Xc(a.c,b);return c||b[b.length-1]==a.c.keyPath&&(c=Xc(a.c,b.slice(0,b.length-1)))?c:null}
function Re(a){return(a=Qe(a))?a.getName():void 0}Le.prototype.reverse=function(){var a=this.clone();a.h=!this.h;return a};Le.prototype.unique=function(a){var b=this.clone();b.g=!!a;return b};function Pe(a){return 0<a.b.length?!0:1==a.f.length?a.f[0]!=a.c.keyPath:1<a.f.length?!0:!1}
...
f.h.length?f.keyPath===g:w(g)&&Ia(f.h,g)))}if(f&&c[e]!=d)throw new F('select field name must be "'+d+'", but "'+c[e]+'" found.');}d=3}else throw new F("Selecting more than 2 field names is not supported, but "+c.length+" fields selected.");return new Z(this.db,this.b,d,a)};l.vb=function(a){a=a||100;var b=4,c=Ve(this);this.c&&this.c[0]&&(c=Jd(c,this.c[0],this.c[1]));if(2==this.type||3==this.type||1==this.type)b=this.type;a=ie(this.db,b,c,a);a.w(function(){"rest"==c.g&&(this.c=[c.j,c.m])},this);return a};
l.za=function(){return[this.a.clone()]};function Ve(a,b){var c=!!b;r(b)||(c=2==a.type||3==a.type||1==a.type);return Oe(a.a,!c)}l.nb=function(a,b){var c=Ve(this);c.c&&(c=new Fd(c.b,c.f,c.a,Hd(c),Id(c),!1,c.h));var d=this.db.open(function(c){var f=c.pa();if(x(a))Ub(f,a,b);else if(t(a))for(var g=0;g<a.length;g++)Ub(f,a[g],b[g]);else if(B(a))for(g in a)a.hasOwnProperty(g)&&(f[g]=a[g]);xb(d,c.update(f))},c,I,this);return d};l.open=function(a,b){return this.db.open(a,Ve(this,!1),I,b)};
l.count=function(){return Pe(this.a)?this.a.g?this.db.count(Oe(this.a)):this.db.count(this.a.c.getName(),Re(this.a),this.a.a):this.db.count(this.a.c.getName(),this.a.a)};l.clear=function(){return Pe(this.a)?this.db.clear(this.a.c.getName(),Re(this.a),this.a.a):this.db.clear(this.a.c.getName(),this.a.a)};
pe.prototype.from=function(a,b,c,d,e){if(!nd(this.c,a))throw new F('Store "'+a+'" not found.');var f=null;if(r(b)){if(!r(c))throw new F("boundary value must be defined.");f=Hc(b,c,d,e)}else if(r(d))throw new F("second boundary must not be defined.");a=new Le(T(this.c,a),f);return new Z(this.b,this.c,null,a)};
